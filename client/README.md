...
- ทุกคนต้องผ่านหน้า **Login** ก่อนใช้งาน ใช้รหัส User/Password ที่ ADMIN หรือผู้ได้รับสิทธิ์สร้างให้ ไม่มีสมัครสมาชิก
- **บัญชีของฉัน** เปลี่ยน Password โดยยืนยัน Password เดิม เมื่อสำเร็จต้อง Login ใหม่ทุกอุปกรณ์
- **จัดการผู้ใช้** สร้าง/แก้ไข/ระงับ/ลบบัญชี กำหนดแผนก สาขา บทบาท และรีเซ็ต Password ตามสิทธิ์
- **Log** ดูประวัติ Login/Logout การจัดการผู้ใช้ สิทธิ์ Password และคำขอ เฉพาะผู้มีสิทธิ์
...
รายละเอียดสิทธิ์และ API: [คู่มือบัญชีและสิทธิ์](docs/auth-handoff.md)
